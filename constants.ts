...
export const ALL_GALLERY_IMAGES: GalleryImage[] = [
  ...
  { id: 8, src: 'https://i.imgur.com/eTmWKuz.png', alt: 'Gallery image 8' },
  { id: 9, src: 'https://i.imgur.com/LT9Ccub.png', alt: 'Gallery image 9' },
  { id: 11, src: 'https://i.imgur.com/U60GPlU.png', alt: 'Gallery image 11' },
  { id: 12, src: 'https://i.imgur.com/5PXCT9I.png', alt: 'Gallery image 12' },
  { id: 13, src: 'https://i.imgur.com/kA82pHe.png', alt: 'Gallery image 13' },
  { id: 14, src: 'https://i.imgur.com/iSOaQxy.png', alt: 'Gallery image 14' },
  { id: 15, src: 'https://i.imgur.com/h4RgeYJ.png', alt: 'Gallery image 15' },
  { id: 16, src: 'https://i.imgur.com/veYO5sP.png', alt: 'Gallery image 16' },
  { id: 17, src: 'https://i.imgur.com/wYqwpff.png', alt: 'Gallery image 17' },
  { id: 18, src: 'https://i.imgur.com/KRSt0J5.png', alt: 'Gallery image 18' },
  { id: 19, src: 'https://i.imgur.com/nCzLD5L.png', alt: 'Gallery image 19' },
  { id: 20, src: 'https://i.imgur.com/8D4WcDf.png', alt: 'Gallery image 20' },
  { id: 21, src: 'https://i.imgur.com/SJ7UCAO.png', alt: 'Gallery image 21' },
  ...
  { id: 28, src: 'https://i.imgur.com/7NztZ2H.png', alt: 'Gallery image 28' },

  { id: 33, src: 'https://i.imgur.com/9eAMXQs.png', alt: 'Gallery image 33' },
  { id: 39, src: 'https://i.imgur.com/m35LR1N.png', alt: 'Gallery image 39' },
  { id: 40, src: 'https://i.imgur.com/btIBFhX.png', alt: 'Gallery image 40' },
];
